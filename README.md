...
💻 Junior Front-End Developer with a passion for building clean and responsive user interfaces.

🔐 Interested in Penetration Testing & Bug Bounty, always exploring web security and vulnerabilities.
